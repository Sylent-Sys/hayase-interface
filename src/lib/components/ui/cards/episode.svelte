...
<div class='text-white p-4 cursor-pointer shrink-0 relative pointer-events-auto touch-manipulation' class:z-40={!hidden} use:hover={[onclick, onhover]}>
  {#if !hidden}
    <PreviewCard {media} {trace} {mobile} onClose={closePreview} />
  {/if}
